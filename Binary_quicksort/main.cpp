...
#include <ctime>
#include <chrono>
#include "../../../../../../../3semester/ВычТех/1/1labVT/1labVT/functionsL.cpp"
#define BITS_WORD 32
#define BITS_BYTE 8
...
/*
 * 6. Пусть даны три файла целых положительных чисел,
 * состоящих из 100, 1000 и 10000 чисел.
 * Выполнить сортировку данных с помощью
 * метода двоичной быстрой сортировки.
 */
